  <section id="content">
    ...
    <article class="object <?php  if($datas->active != 1){ echo 'archive'; } ?>">
      <div class="action">
        ...
        <?php }else{ ?>
          <a class="icon edit" href="collectiondetails/<?php  echo $datas->id; ?>">&#xf040;</a>
      ...
      <div class="content">
        <div class="illustration" style="background-image: url(<?php echo base_url(); ?>assets/images/news/placeholder.png);"></div>
